...
public class QuickStartHelp2 extends JFrame {
  ...
  java.net.URL urlat=getClass().getResource("tableview.gif");
  JMenuItem attribitem = new JMenuItem("open attribute table",
                            new ImageIcon(urlat));
  java.net.URL urlcl=getClass().getResource("Icon0915b.jpg");
  ...
  JMenuItem demoteitem = new JMenuItem("demote selected layer",
                    new ImageIcon("data\\demote1.gif"));
  static JMenuItem promoteitem = new JMenuItem("promote selected layer",
                    new ImageIcon("data\\promote1.gif"));
  java.net.URL urlpr=getClass().getResource("print.gif");
JMenuItem printitem = new JMenuItem("print",new ImageIcon(urlpr));       
 
  java.net.URL urlath=getClass().getResource("addtheme.gif");
 JMenuItem addlyritem = new JMenuItem("add layer",new ImageIcon(urlath));
 java.net.URL urlde=getClass().getResource("delete.gif");
 JMenuItem remlyritem = new JMenuItem("remove layer",new ImageIcon(urlde));
  java.net.URL urlpro=getClass().getResource("properties.gif");
 JMenuItem propsitem = new JMenuItem("Legend Editor",new ImageIcon(urlpro));
  JMenu helptopics = new JMenu("Help Topics");
   java.net.URL urlhelp=getClass().getResource("help2.gif");
  JMenuItem tocitem = new JMenuItem("Table of Contents",new
ImageIcon(urlhelp));
JMenuItem legenditem = new JMenuItem("Legend Editor",new ImageIcon(urlhelp));
  JMenuItem layercontrolitem = new JMenuItem("Layer Control",new
ImageIcon(urlhelp));
   JMenuItem helptoolitem = new JMenuItem("Help Tool",new ImageIcon(urlhelp));
  JMenuItem contactitem = new JMenuItem("Contact us");
  JMenuItem aboutitem = new JMenuItem("About MOJO...");

    static Toc toc = new Toc();
     String s1 = "data\\states.shp";
  String s2 = "data\\capitals.shp";
   String s3 = "data\\24fit.shp";
   
   String s4="data\\estados.shp";
   String s5= "data\\capitales.shp";
    String datapathname = "";
    String legendname = "";
  ...
  JButton prtjb = new JButton(new ImageIcon(urlpr));
  JButton addlyrjb = new JButton(new ImageIcon(urlath));
  
  java.net.URL urlpoi=getClass().getResource("pointer.gif");
  JButton ptrjb = new JButton(new ImageIcon(urlpoi));
  java.net.URL urldr=getClass().getResource("draw_point_1.gif");
  JButton drawPtjb=new JButton(new ImageIcon(urldr));
  java.net.URL urlm=getClass().getResource("measure_1.gif");
  JButton distjb = new JButton(new ImageIcon(urlm));
    
  JButton XYjb = new JButton("XY");
  java.net.URL urlhotlink=getClass().getResource("hotlink.gif");
  JButton hotjb = new JButton(new ImageIcon(urlhotlink));
  java.net.URL url24=getClass().getResource("24icon.gif"); 
   JButton link = new JButton(new ImageIcon(url24));
  java.net.URL urlcheck=getClass().getResource("check.gif");  
  JButton checkbox= new JButton(new ImageIcon(urlcheck));
  Toolkit tk = Toolkit.getDefaultToolkit();
 java.net.URL urlhotlink32=getClass().getResource("hotlink_32x32-32.gif");
 Image bolt = tk.getImage(urlhotlink32);  // 32x32 gif file

  java.awt.Cursor boltCursor = tk.createCustomCursor(bolt,new java.awt.Point(6,30),"bolt");
  
  JButton helpjb = new JButton(new ImageIcon(urlhelp));
    ...
    MouseAdapter mlLisAddLayer = new MouseAdapter() {
	 ...
	 lanlis = new ActionListener() {
          public void actionPerformed(ActionEvent ae){
               ...
               file.setText("File");
        addlyritem.setText("AddLayer");
        remlyritem.setText("RemoveLayer");
        prtjb.setToolTipText("Print");
        addlyrjb.setToolTipText("AddLayer");
        ...
        addlyritem.setText("Agregar Capa");
        remlyritem.setText("Eliminar Capa");
        prtjb.setToolTipText(" Imprimir");
        addlyrjb.setToolTipText("Agregar Capa");
                ...
                if (source instanceof JMenuItem) {
                    ...
                    if (arg == "add layer") {
                        ...
                        try {
                            ...
                            Logger.getLogger(QuickStartHelp2.class.getName()).log(Level.SEVERE,
null, ex);
                        }
...
java.awt.Color(30,180,140)));
   ...
   sym2.setImageString( "data\\24.jpg" );
        sym2.setSizeX(16); 
        sym2.setSizeY(16);
    ...
    public static void main(String[] args) {
        QuickStartHelp2 qstart = new QuickStartHelp2();
...
com.esri.mo2.ui.bean.CustomDatasetEditor();
                ...
                public void actionPerformed(ActionEvent ae) {
                    ...
                    if (source == cancel) {
                        ...
                        try {
                            ...
                            map.redraw();
                            if (QuickStartHelp2.stb.getSelectedLayers() != null) {
                                QuickStartHelp2.promoteitem.setEnabled(true);
                            }
                        } catch (IOException e) {
                        }
                    }
    ...
    class AttrTab extends JDialog {
      JPanel panel1 = new JPanel();
      com.esri.mo2.map.dpy.Layer layer = QuickStartHelp2.layer4;
      ...
      public AttrTab() throws IOException {
                QuickStartHelp2.jtable = new JTable(new MyTableModel());
                JTable jtable = QuickStartHelp2.jtable;
  ...
  public XYfeatureLayer(BasePointsArray bpa,Map map,Vector s2,Vector s3) {
        ...
        rmSymbol.setImageString( "data\\24.jpg" );
...
(QuickStartHelp2.layer4.getLayerSource()))
                            .getPath();
...
ae) {
      ...
      path = pathField.getText().trim();
          ...
          name = nameField.getText().trim();
          //path = ((ShapefileFolder)(QuickStartHelp2.layer4.getLayerSource())).getPath();
          System.out.println(path+"    " + name);
    }
        else if (o == cancel)
      setVisible(false);
...
class HelpTool extends Tool {
  ...
  public void arrowChores() { // undo measure tool residue
    QuickStartHelp2.milesLabel.setText("DIST   0 mi   ");
    QuickStartHelp2.kmLabel.setText("   0 km    ");
    if (QuickStartHelp2.acetLayer != null)
      QuickStartHelp2.map.remove(QuickStartHelp2.acetLayer);
    QuickStartHelp2.acetLayer = null;
    QuickStartHelp2.map.repaint();
    QuickStartHelp2.helpToolOn = false;
  }
 }
   class DrawPoint extends Tool {
  Map map = QuickStartHelp2.map;
  ...
  public void mousePressed(MouseEvent me) {
        ...
        initPoint = QuickStartHelp2.map.transformPixelToWorld(me.getX(),me.getY());
  }
  public void mouseReleased(MouseEvent me) {
          // now we create an acetatelayer instance and draw a line on it
        endx = me.getX(); endy = me.getY();
        endPoint = QuickStartHelp2.map.transformPixelToWorld(me.getX(),me.getY());
...
endPoint.x))*2*Math.PI/360)));
    ...
    QuickStartHelp2.milesLabel.setText("DIST: " + new
Float((float)distance).toString() + " mi  ");
    QuickStartHelp2.kmLabel.setText(new Float((float)(distance*1.6093)).toString() +
" km");
    if (QuickStartHelp2.acetLayer != null)
      QuickStartHelp2.map.remove(QuickStartHelp2.acetLayer);
    QuickStartHelp2.acetLayer = new AcetateLayer() {
      public void paintComponent(java.awt.Graphics g) {
                java.awt.Graphics2D g2d = (java.awt.Graphics2D) g;
    ...
    QuickStartHelp2.map.add(QuickStartHelp2.acetLayer);
    QuickStartHelp2.map.redraw();
  }
...
class HotPick extends JDialog {
     int pick=QuickStartHelp2.mypick;
   
  HotPick(int j) throws IOException {

    setBounds(100,100,500,500);
     
    String image[][]={{"image1.jpg","Sport club","https://www.24hourfitness.com/Website/Club/71"},
        {"image2.jpg","Super club","https://www.24hourfitness.com/Website/Club/60"},
        {"image3.jpg","Sport club","http://www.24hourfitness.com/Website/Club/101"},
        {"image4.jpg","Super club","https://www.24hourfitness.com/Website/Club/927"},
        {"image5.jpg","Super club","http://www.24hourfitness.com/Website/Club/00880"},
        {"image6.jpg","Sport club","http://www.24hourfitness.com/Website/Club/00114"},
        {"image7.jpg","Super club","http://www.24hourfitness.com/Website/Club/95"},
        {"image8.jpg","Super club","http://www.24hourfitness.com/Website/Club/873"},
        {"image9.jpg","Sport club","http://www.24hourfitness.com/Website/Club/167"},
        {"image10.jpg","Sport club","http://www.24hourfitness.com/Website/Club/59"},
        {"image11.jpg","Sport club","http://www.24hourfitness.com/Website/Club/90"},
        {"image12.jpg","Super club","https://www.24hourfitness.com/Website/Club/892"},
        {"image13.jpg","Super club","http://www.24hourfitness.com/Website/Club/872"},
            {"image14.jpg","Sport club","http://www.24hourfitness.com/Website/Club/57"},
            {"image15.jpg","Sport club","https://www.24hourfitness.com/Website/Club/00888"},
            {"image16.jpg","Super club","http://www.24hourfitness.com/Website/Club/00160"},
            {"image17.jpg","Super club","http://www.24hourfitness.com/Website/Club/00191"}
        };
    setTitle(image[j][1]);
    JPanel jpanel = new JPanel();
    JPanel jpanel2 = new JPanel();
	java.net.URL urlurl=getClass().getResource(image[j][0]);
    JLabel label = new JLabel(new ImageIcon(urlurl));
